            ...
            <div className="container faq-container">
                ...
                <div className="accordion" id="faq">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" className="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#faq">
                        <div className="accordion-body">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" className="accordion-collapse collapse show" aria-labelledby="headingThree" data-bs-parent="#faq">
                        <div className="accordion-body">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFour" className="accordion-collapse collapse show" aria-labelledby="headingFour" data-bs-parent="#faq">
                        <div className="accordion-body">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFive" className="accordion-collapse collapse show" aria-labelledby="headingFive" data-bs-parent="#faq">
                        <div className="accordion-body">
